// This is a template for implementing cellular automata simulations.
// It is based on is conways game of life.
...
// Pad the number k with leading zeros, such that it has the same number of digits as Max
